...
var svg = d3.select(".choroContainer").append("svg")
                        .attr("width", w)
                        .attr("height", h)
                        .attr("fill", "grey")
                        .attr("class", function(d) { return "choroSVG"})
...
var lsvg = d3.select(".lineContainer")
    .append("svg")
    .attr("width", lw)
    .attr("height", lh)
    .attr("class", function(d) { return "lineSVG"});
